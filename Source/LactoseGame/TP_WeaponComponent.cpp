...
void UTP_WeaponComponent::Fire()
{
	...
	if (ProjectileClass != nullptr)
	{
		...
		if (World != nullptr)
		{
			...
			World->SpawnActor<ALactoseGameProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
		}
	}
...
bool UTP_WeaponComponent::AttachWeapon(ALactoseGameCharacter* TargetCharacter)
{
