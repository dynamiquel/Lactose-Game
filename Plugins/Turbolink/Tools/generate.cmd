...
set PROJECT_PATH=E:\Lactose\Client\LactoseGame
set SOURCE_PATH=%PROJECT_PATH%\Source\LactoseGame
set SERVICES_PRIVATE_PATH=%SOURCE_PATH%\Private\Services
set SERVICE_PATH=%SERVICES_PRIVATE_PATH%\Identity
set SERVICE_PROTOS_PATH=%SERVICE_PATH%\Protos

set TL_UE_PLUGIN_PATH=%PROJECT_PATH%\Plugins\Turbolink

::make sure input proto files exist
set INPUT_PROTO_FILE=%SERVICE_PROTOS_PATH%\%1.proto
...
set OUTPUT_PATH=%SERVICE_PATH%\Gen
