...
{
	// @SPLASH_DAMAGE_CHANGE: eddie.stubbington@splashdamage.com - BEGIN: Added checks for GameInstance & World to ensure not NULL. 
	if (World != nullptr && World->GetGameInstance() != nullptr && (World->WorldType == EWorldType::Game || World->WorldType == EWorldType::PIE
		|| World->WorldType == EWorldType::Editor))
	// @SPLASH_DAMAGE_CHANGE: eddie.stubbington@splashdamage.com - END: Added checks for GameInstance & World to ensure not NULL. 
	{
